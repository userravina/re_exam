    ...
    switch (click) {
      ...
      case "9":
        ...
        if (controller.displayOprater.value == "M+" ||
          ...
          display = controller.memory.value.toString() + controller.prevOpertor.value;
            ...
            if(controller.value[0].isEmpty)
            ...
            else
              {
                ...
                if (controller.value[lastIndex].contains('=')) {
                  ...
                  double squareRoot = sqrt(double.parse(controller.displayEnglish.value));
          ...
          if (controller.displayEnglish.value.isEmpty) {
            ...
            if (controller.value.isEmpty) {
              ...
              if (controller.value[0].isEmpty) {
                ...
                print("------- lastIndex ------ ${lastIndex}");
                if (controller.value[lastIndex].contains('=')) {
                  controller.value.add(controller.value[lastIndex].replaceAll("=", ''));
                  controller.saveValueListToPrefs();
                  controller.result.value = double.parse(controller.value[lastIndex].replaceAll("=", ''));
                } else {
          ...
          if (controller.displayEnglish.value.isEmpty) {
            ...
            if (controller.prevOpertor.value == "MU") {
              ...
              if (controller.prevOpertor.value == "-") {
                ...
                print('nnnnnnnnnnn3333333333111111111 ${controller.result.value}');
                controller.result.value -=
                    double.parse(controller.displayEnglish.value);
              }
              if (controller.prevOpertor.value == "*") {
      ...
      case "+":
        ...
        arathmeticoperator == true ? controller.value.add(controller.display.value):controller.value.add(controller.prevOpertor.value +
                        controller.display.value);
                    controller.saveValueListToPrefs();
                  }
                }
